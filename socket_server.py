...
# 	global global_s, conn,receive_thread_task_complete, client_IP
...
# 	global global_s, conn, transfer_thread_task_complete, client_IP
...
# 				print (client_IP)
# 				#global_s.connect((client_IP, 5001))
...
# 				conn.send(b'Processed image has been shared with client')
